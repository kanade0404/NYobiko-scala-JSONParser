...
object PostalCodeParser extends MyFirstCombinator {
  ...
  def townConde: Parser[String] = map(combine(combine(combine(digit, digit), digit), digit), {
    t: (((String, String), String), String) => t._1._1._1 + t._1._1._2 + t._1._2 + t._2
  })

  def apply(input: String): ParserResult[PostalCode] = map(combine(combine(zoneCode, s("-")), townConde), {
